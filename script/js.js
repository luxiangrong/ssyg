$(function(){
	...
	$('.aboutNav').find('a').each(function(i){
			$(this).click(function(){
				...
				$('body,html').animate({scrollTop: $('.aboutPart').eq(i).offset().top-50}, 500);
				})
		})
	...
	$('.webPart1').find('a').each(function(i){
		$(this).click(function(){
			$('body,html').animate({scrollTop: $('.webPart1Div').eq(i).offset().top-50}, 500);
			})
		})
	$('.MobilePart1').find('a').each(function(i){
		$(this).click(function(){
			$('body,html').animate({scrollTop: $('.MobilePart1Div').eq(i).offset().top-50}, 500);
			})
		})
	//--
	$('.topA').click(function(){
